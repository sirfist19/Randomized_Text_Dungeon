...
const int CHAINMAIL_CHESTPLATE_DEFENSE = 1;
const int CHAINMAIL_BOOTS_DEFENSE = 1;

const int BRONZE_HELMET_DEFENSE = 1;
const int BRONZE_CHESTPLATE_DEFENSE = 1;
const int BRONZE_BOOTS_DEFENSE = 1;

const int SILVER_HELMET_DEFENSE = 1;
const int SILVER_CHESTPLATE_DEFENSE = 1;
const int SILVER_BOOTS_DEFENSE = 1;

const int DRAGON_SCALE_HELMET_DEFENSE = 1;
const int DRAGON_SCALE_CHESTPLATE_DEFENSE = 1;
const int DRAGON_SCALE_BOOTS_DEFENSE = 1;
#endif
